...
As a result, with support from class faculty, I turned the opacity of these colors to 0 and minimized the width of the column to essentially remove it. This resulted in my final visualization. 
